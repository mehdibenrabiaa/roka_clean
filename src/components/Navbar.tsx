        ...
        <ul className="hidden md:flex items-center gap-8">
          {navLinks.map((link) => (
            <li key={link.href}>
              <Link
                href={link.href}
                className="text-sm font-medium text-[#1e1e1e] hover:text-[#294a7d] transition-colors"
              >
                {link.label}
              </Link>
            </li>
        ...
        <div className="md:hidden flex items-center gap-2">
          ...
          <Sheet>
            <SheetTrigger asChild>
              <button
                className="p-2 rounded-full text-[#1e1e1e] hover:text-[#294a7d] transition-colors cursor-pointer"
